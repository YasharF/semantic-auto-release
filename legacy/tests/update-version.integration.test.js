...
describe("(legacy) scripts/update-version.js", function () {
  ...
  it("should update package.json and package-lock.json version", function () {
    execSync("node scripts/update-version.js 9.9.9");
  ...
  it("should error if no version is provided", function () {
    const proc = spawnSync("node", ["scripts/update-version.js"], {
      encoding: "utf8",
    });
    expect(proc.stderr).to.include("Usage: update-version.js <version>");
  });
});
